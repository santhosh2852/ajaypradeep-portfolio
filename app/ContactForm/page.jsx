...
const ContactForm = () => {
  ...
  return (
    <div>
      <NavBar/>
    <div className='bg-white overflow-x-hidden w-screen bg-cover h-[100vh] mx-auto my-auto'>
      <div className='md:shadow-2xl md:shadow-black relative md:top-44 top-0 md:border-black bg-white md:w-[50%] mx-auto my-auto rounded-xl p-5'>{/*This is for box shadow*/}
