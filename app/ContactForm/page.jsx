...
const ContactForm = () => {
  ...
  return (
    <div>
      <NavBar/>
      <div className='bg-white overflow-x-hidden w-screen bg-cover h-[100vh] mx-auto my-auto md:pb-48'>
        <div className='md:shadow-2xl md:shadow-black relative md:top-36 md:pb-4 top-0 md:border-black bg-white md:w-[50%] mx-auto my-auto rounded-xl p-5'>{/*This is for box shadow*/}
          <Image src='/Black_Logo.png' className='ml-auto mr-auto flex pt-[150px] md:pt-0'
          width={100}
          height={100}
          alt='Logo'
          /><br/><br/>
          <div className='mx-auto my-auto items-center justify-center text-center'>
          <input required type='text' ref={input1Ref} placeholder='Enter Your Name' className='border-[#86868b] border-2 md:w-[300px] w-[300px] rounded text-black h-10 text-center' onKeyDown={(e) => handleKeyPress(e, input2Ref)}/><br/><br/>
