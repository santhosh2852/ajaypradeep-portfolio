...
const AboutUs = () => {
  ...
  return (
    ...
    >
            <div>
                <p className='relative text-3xl left-5 font-bold'>Additional Qualifications</p><br/><br/>
                <Swiper
                loop={true}
                navigation={true}
        ...
        >
            <div className='grid md:grid-cols-2 grid-cols-1 gap-y-5 items-center justify-center mx-auto md:mx-40 place-items-center-center w-screen'>
                <div className='border-black mx-auto justify-center items-center md:h-60 md:w-[50%] md:justify-start md:mx-0 text-center border-2 p-5 shadow-2xl shadow-black w-60 bg-white'>
                ...
                <div className='border-black mx-auto justify-center items-center md:h-60 md:w-[50%] md:mx-0 text-center border-2 p-5 shadow-2xl shadow-black w-60 bg-white'>
            ...
            <br/>
            <p className='font-black text-xl m-0 text-center'>Professional Snapshot</p>
            <Swiper loop={true} pagination={true} modules={[Pagination]} className="mySwiper text-black mx-auto flex">
                <SwiperSlide><p className='w-[400] h-[400] p-10 shadow-2xl border-black'>Founder of Get Aware Ngo & AJ Unlimited</p></SwiperSlide>
                <SwiperSlide><p className='w-[400] h-[400] p-10 shadow-2xl border-black'>Human Resources Generalist at shyams<br/>Hospitality  Form Jan 2020</p></SwiperSlide>
                <SwiperSlide><p className='w-[400] h-[400] p-10 shadow-2xl border-black'>Human Resource Executivein O2 Health<br/>Studio Form Jan 2019- Jan 2020</p></SwiperSlide>
                <SwiperSlide><p className='w-[400] h-[400] p-10 shadow-2xl border-black'>Assistant Manager Human Resource and Operation<br/>The Midas Touch From July 2017 To November 2018</p></SwiperSlide>
                <SwiperSlide><p className='w-[400] h-[400] p-10 shadow-2xl border-black'>Assistant Manager Human Resource and Operation<br/>Idec from April 2016 To June 2017</p></SwiperSlide>
                <SwiperSlide><p className='w-[400] h-[400] p-10 shadow-2xl border-black'>JUNE 2017 Junior Manager Human Resource &<br/>Admin atHi Volt Engineering Pvt September 2015 To March 2016</p></SwiperSlide>
                <SwiperSlide><p className='w-[400] h-[400] p-10 shadow-2xl border-black'>Human Resource Executive Optimize<br/>India Business Consultancy 2013 June to Apr 2015</p></SwiperSlide>
            </Swiper>
            </motion.div>
    </div>
    <FollowMe/>
